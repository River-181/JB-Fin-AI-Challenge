...
- Diagram tooling lives in `02_제품/scripts/` (`render_mermaid.mjs`, `record_demo.mjs`, `measure_density.js`); `node_modules/` and `test-results/` are regenerable and gitignored.
