...
| 4. MVP 완성도·검증가능성 | 20 | **15** | [[08_feature-spec]]·[[evals/eval-plan\|eval-plan]]·[[evals/golden-cases\|golden-cases]]·[[validation-report]] | 라이브 데모 Ollama 의존·리허설 미실측·e2e 미재실행 |
...
| 현장 데모 미구동 | 🟡 목업은 확실·라이브는 Ollama 기동 필요 → 폴백 준비됨 |
...
2. 라이브 데모 리허설(Ollama)·초단위 확정(축4·영상 +3점).
