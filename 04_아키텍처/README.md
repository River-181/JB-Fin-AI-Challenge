...
| 구현 파일 | 책임 |
| --- | --- |
| [`../app/index.html`](../app/index.html) | 정적 앱 엔트리, 레이아웃 shell |
| [`../app/styles.css`](../app/styles.css) | HagentOS 기반 UI 레이아웃, 반응형, 그룹/패널 스타일 |
| [`../app/app.js`](../app/app.js) | Case, Agent, Skill, Evidence, Approval, Audit 상태와 렌더링 |
| [`../scripts/verify_static.py`](../scripts/verify_static.py) | 필수 정적 파일/문구/구조 검증 |
